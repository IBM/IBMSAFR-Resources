//N99999VC JOB (ACCT),'COMPARE VDP FILES   ',
//          NOTIFY=&SYSUID.,
//          REGION=0M,
//          CLASS=A,
//          MSGLEVEL=(1,1),
...
//*********************************************************************
//*
//*   COMPARE TWO VIEW DEFINITION PARAMETERS (VDP) FILES
//*
//*********************************************************************
//*
//COMPRVDP EXEC PGM=GVBVDPNL,REGION=1024M
//*
//*        <<< INPUT FILES >>>
//*
...
//            DISP=SHR
//*
//VDP2     DD DSN=GEBT.RTC99999.N99999C1.VDP,
//            DISP=SHR
//*
//VDPNPARM DD *
***********************************************************************
